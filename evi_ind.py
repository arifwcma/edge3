...
def get_site(site_file):
    out_file_normal = f"{site_file}_evi_ind_timelapse.gif"
    out_file_date = f"{site_file}_evi_ind_timelapse_date.gif"
    ...
    capture_times = composites_evi.aggregate_array('image_capture_time').getInfo()
